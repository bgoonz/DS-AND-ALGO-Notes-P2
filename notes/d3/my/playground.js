...
class Graph {
  ...
  getEdges() {
    ...
    for (let srcValue in this.graff) {
      ...
      vertex.neighbors.forEach( neiVertex => li.push([srcValue, neiVertex.value]) );
    }
  ...
  adjList() {
    ...
    for (let srcValue in this.graff) {
      ...
      vertex.neighbors.forEach ( neighbor => adjList[srcValue].push(neighbor.value) );
    }
  ...
  depthFirstTraversal(value, visited = new Set(), resLi = new Array()) {
    ...
    adjList[value].forEach( neighbor => this.depthFirstTraversal(neighbor, visited, resLi) );
